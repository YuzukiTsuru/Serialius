...
export function SettingsModal({ open, onClose }: Props) {
  ...
  }, [open, logDirectory, mcpPort, mcpApiKey]);
  ...
  const handleSave = () => {
    update({ logDirectory: logDir.trim(), mcpPort: port, mcpApiKey: apiKey });
    onClose();
  };
          ...
          >
            ...
            <div className="p-4 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                <span className="text-[11px] text-gray-500 uppercase tracking-wider">General</span>
                <div className="flex flex-col gap-1">
                  <label className="text-[11px] text-gray-500">Log Directory</label>
                  <input
                    value={logDir}
              ...
              <div className="flex flex-col gap-3 border-t border-gray-800 pt-3">
                <span className="text-[11px] text-gray-500 uppercase tracking-wider">MCP Server</span>
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-[11px] text-gray-500">Port</label>
                  <input
                    type="number"
                    value={port}
                ...
                <AnimatePresence>
                  {running && (
                    ...
                    >
                      <label className="text-[11px] text-gray-500">Endpoint</label>
